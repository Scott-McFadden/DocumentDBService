...
{
    /// <summary>
    /// ADOService - creates a SQL access service that will access a table that matches the a QueryDef Defintion.
    /// </summary>
    public class ADOService  
    {
        ...
        protected object singleItem = new object();
        ...
        public ADOService(string connection, string tableName)
        {
